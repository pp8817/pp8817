...
| 2024.03.10 <br>~ <br>진행중      | [스스Law](https://github.com/HanIum2024-AILawyer)                                           | 법률 문제를 스스로 해결할 수 있도록 하는 법률 상당 챗봇 서비스     | 한이음 ICT 멘토링                 | Java, SpringBoot, Spring Data JPA, Spring Security <br>Web Socket, Redis, PostgreSql, AWS EC2, AWS RDS                                |
