...
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ | ---------------------------- | --------------------------------------------------------------------------------------------- |
| 2024.05.12 <br>~ <br>진행중      |   [SUCAT](https://github.com/Suwon-University-Community-SUCAT/Sucat-Server)                                | 게임, 친구추가, 채팅을 접목시킨 친목형 대학교 커뮤니티   | BE 팀장  | Java, SpringBoot, Spring Data JPA, Spring Security <br> Web Socket, Redis, MySql, AWS EC2, AWS RDS                                                               |
| 2024.05.10 <br>~ <br>진행중      | [스스Law](https://github.com/HanIum2024-AILawyer/SSL-Server)                                           | 법률 문제를 스스로 해결할 수 있도록 도움을 제공하는 법률 상당 챗봇 서비스     | BE 팀장<br>개발 동아리 Semicolon  | Java, SpringBoot, Spring Data JPA, Spring Security, OAuth 2.0 <br>Web Socket, Redis, PostgreSql, AWS EC2, AWS RDS                                |
